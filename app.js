...
${lines.join("\n")}`, raw: rawResponses.join("\n\n") };
  ...
  function loginScreen() {
    const google = isLocalShell() ? "" : `<a class="google-login-button" href="${cloudflareConfig2.authEndpoints.google}?returnTo=%2F"><span class="google-mark" aria-hidden="true">G</span><span>Continue with Google</span></a><div class="login-divider"><span>or use your email</span></div>`;
