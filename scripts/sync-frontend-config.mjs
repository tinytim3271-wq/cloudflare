...
const safeApiUrl = apiUrl.replaceAll("'", "\\'");
const next = `/**
...
export const cloudflareConfig = Object.freeze({
  ...
  apiUrl: '${safeApiUrl}',
  authEndpoints: {
    magicLink: '${safeApiUrl}/auth/magic-link',
    callback: '${safeApiUrl}/auth/callback',
    session: '${safeApiUrl}/auth/session',
    logout: '${safeApiUrl}/auth/logout',
  },
});
